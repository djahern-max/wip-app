...
| ID | Item | Status |
|---|---|---|
| S-01 | QBO read-only spike: projects as customers, line-level refs, CDC deletes (sandbox in F05; Ramp line check in F05.1) | ◐ (answers (a)–(d) in BLUEPRINT §13.7; question 4 runs on the real company with `scripts/s01_q4.py`, ids into §13.7) |
...
### F05.1 · QBO production connection  ◐ (built 2026-09-22; Rye Beach connected 2026-09-22, tie-out 2026-09-23; open: attached-accounts figure, S-01 question 4 run, owner phone pass)
