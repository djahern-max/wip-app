...
| ID | Item | Status |
|---|---|---|
| S-01 | QBO read-only spike: projects as customers, line-level refs, CDC deletes (sandbox in F05; Ramp line check in F05.1) | ☑ (2026-09-25; answers in BLUEPRINT §13.7; the Ramp line check on the real company is recorded there when the owner supplies three Purchase/Bill ids) |
...
### F05.1 · QBO production connection  ☑ (2026-09-25; tie-out 2026-09-23; three criteria left open for the owner: chart export, S-01 question 4 ids, the phone pass tick)
